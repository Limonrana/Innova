               ...
               <!-- <li class="dropdown notification-list">
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                       aria-haspopup="false" aria-expanded="false">
                        <img src="uploads/users/<?php echo $_SESSION['photo']; ?>" alt="user" class="rounded-circle"> <span class="ml-1">Limon Rana <i class="mdi mdi-chevron-down"></i> </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                        ...
                        <!-- item-->
                        <a href="single-profile.php" class="dropdown-item notify-item">
            ...
            <ul class="list-inline menu-left mb-0">
                ...
                <li>
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Welcome to Fast Freelance BD admin panel !</li>
                        </ol>
                    </div>
                </li>
