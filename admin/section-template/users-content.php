...
$select_data = "SELECT * FROM users WHERE status='1' or status='2'";
                    ...
                    <div class="text-center card-box">
                        ...
                        <div class="member-card pt-2 pb-2">
                            <div class="thumb-lg member-thumb m-b-10 mx-auto">
                                <img src="uploads/users/<?php echo $item['photo'];?>" class="rounded-circle img-thumbnail"
                                     alt="profile-image">
                            </div>
                            ...
                            <ul class="social-links list-inline m-t-20">
                                <li class="list-inline-item">
                                    <a href="<?php echo $item['facebook']; ?>"><i class="fa fa-facebook"></i></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="<?php echo $item['twitter']; ?>"><i class="fa fa-twitter"></i></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="<?php echo $item['skype']; ?>"><i class="fa fa-skype"></i></a>
                                </li>
                            </ul>
