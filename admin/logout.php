...
<?php
require 'inc/logout/logout_post.php';
?>
<!--Logout Function End-->
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5 m-auto">
                            ...
                            <div class="text-center m-b-20">
                                ...
                                <p class="text-muted font-14 m-t-10"> You are now successfully sign out. Back to <a href="index.php" class="text-dark m-r-5"><b>Sign In</b></a></p>
                            </div>
